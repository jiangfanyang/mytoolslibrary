...
public class L {
    ...
    // 下面四个是默认tag的函数
    public static void i_T(String... msg) {
        if (isDebug)
            printLog(I, msg);
    }

    public static void d_T(String... msg) {
        if (isDebug)
            printLog(D, msg);
    }

    public static void w_T(String... msg) {
        if (isDebug)
            printLog(W, msg);
    }

    public static void e_T(String... msg) {
        if (isDebug)
            printLog(E, msg);
    }

    public static void v_T(String... msg) {
        if (isDebug)
            printLog(V, msg);
    }
