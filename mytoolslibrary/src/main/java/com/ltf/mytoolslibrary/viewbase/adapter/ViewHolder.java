...
/**
 * Created by 李堂飞李堂飞 on 2015/9/13.
 */
public class ViewHolder {

    //SparseArray的键只能为Integer.
    ...
    public ViewHolder(Context context, ViewGroup parent, int layoutId,
        ...
        AutoUtils.auto(mConvertView);//列表适配实际屏幕
    }

    /**
     * 在Adapter，在getView里面；首先调用ViewHolder的get方法
     * 如果convertView为null，new一个ViewHolder实例
     * 通过使用mInflater.inflate加载布局
    ...
    public RatingBar getRdtingBar(int viewId) {
    ...
    public ViewHolder setImgUrl(int viewId, Uri uri) {
        ImageView simpleDraweeView = getView(viewId);
